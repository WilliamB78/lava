 ...
 */
class Version20180417081551 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE start start DATETIME NOT NULL, CHANGE end end DATETIME NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE start start TIME NOT NULL, CHANGE end end TIME NOT NULL');
